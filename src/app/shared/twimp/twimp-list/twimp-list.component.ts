...
export class TwimpListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.twimps.push(
      ...
      new TwimpModel('1', '', this.authors[0], this.text, '01/01/2023', true)
    );
    this.twimps.push(
      new TwimpModel('2', '', this.authors[0], this.text, '01/01/2023', true)
    );
    this.twimps.push(
      new TwimpModel('3', '', this.authors[0], this.text, '01/01/2023', true)
    );
    this.twimps.push(
      new TwimpModel('4', '', this.authors[0], this.text, '01/01/2023', true)
    );
  }
